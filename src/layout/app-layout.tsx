...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'head-coach', 'team-manager', 'coach'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Meet', path: '/meets', entity: 'meet', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Result', path: '/results', entity: 'result', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Swimmer', path: '/swimmers', entity: 'swimmer', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Team', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiShield },
    {
      name: 'Training Plan',
      path: '/training-plans',
